        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="?page=register&action=checkRegister">
                        <div class="row">
                    ...
                    <form role="form" method="post" action="?page=login">
                        <input type="submit" value="Go to login" class="btn btn-success btn-block">

                    </form>
                    <pre><?php var_dump($this->getErrors()); ?></pre>
                </div>
